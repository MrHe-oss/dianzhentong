...
电诊通是面向电气工程及其自动化专业学生的教材知识学习平台。v3.3 将首页精简为教材主入口、继续学习和三个辅助入口，课程详情、练习与实训各自进入独立页面；识图、虚拟实训和故障诊断作为配套巩固工具。首本试点教材为《电气控制与PLC应用技术（S7-1200）》，该映射不是出版社或作者提供的官方配套资源，现有成绩与旧备份保持兼容。
