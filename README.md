...
电诊通是面向电气工程及其自动化专业学生的教材知识学习平台。v3.9 为教材单元增加学习效果闭环：先完成3题学前小测，再学习小课并参加5题学后评测，系统显示前后正确率变化；单元错题可以直接返回教材对应小课复习。识图、虚拟实训和故障诊断仅作为配套巩固工具。首本试点教材为《电气控制与PLC应用技术（S7-1200）》，该映射不是出版社或作者提供的官方配套资源，所有例题与练习均为平台原创，现有成绩与旧备份保持兼容。
