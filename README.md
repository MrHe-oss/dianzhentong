...
电诊通是面向电气工程及其自动化专业学生的教材知识学习平台。v4.3 新增《电气控制与PLC应用技术（S7-1200）》项目2“初识S7-1200 PLC”的4个目录任务、12个原创知识小课和4个原创例题。项目与任务名称依据机械工业出版社公开目录，讲解、即时检查和变式练习均由平台独立编写。识图、虚拟实训和故障诊断仅作为配套巩固工具，现有成绩与旧备份保持兼容。
...
- 33张知识卡、90道题、20类模拟故障和18个识图案例均显示可追溯来源；
