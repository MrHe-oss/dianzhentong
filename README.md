...
电诊通是面向电气工程及其自动化专业学生的教材知识学习平台。v3.5 将“电动机单向旋转控制”建设为首个完整样板单元，包含单元导学、8节原创小课、即时检查、连续导航和学习进度；识图、虚拟实训和故障诊断仅作为配套巩固工具。首本试点教材为《电气控制与PLC应用技术（S7-1200）》，该映射不是出版社或作者提供的官方配套资源，现有成绩与旧备份保持兼容。
