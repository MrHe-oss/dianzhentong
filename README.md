...
电诊通是面向电气工程及其自动化专业学生的知识、练习与虚拟实训学习平台。v3.1 首次接入《电气控制与PLC应用技术（S7-1200）》教材目录映射，先覆盖项目1的单向旋转、正反转和星—三角启动三个任务，并关联平台原创知识点、练习、识图和实训。该映射不是出版社或作者提供的官方配套资源，现有成绩与旧备份保持兼容。
