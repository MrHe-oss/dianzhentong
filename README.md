...
电诊通是面向电气工程及其自动化专业学生的教材知识学习平台。v3.8 为“电动机单向旋转控制”样板单元增加8组抽象原理图解、自锁状态演示和正式单元评测；单元掌握状态综合知识学习、70%评测通过和互动识图记录计算。识图、虚拟实训和故障诊断仅作为配套巩固工具。首本试点教材为《电气控制与PLC应用技术（S7-1200）》，该映射不是出版社或作者提供的官方配套资源，所有例题与练习均为平台原创，现有成绩与旧备份保持兼容。
