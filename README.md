...
电诊通是面向电气工程及其自动化专业学生的教材知识学习平台。v3.7 在项目1的18节原创小课基础上增加适用的抽象逻辑公式、符号解释、三个原创综合例题、分步解析和变式练习；不适合公式的内容不强行公式化。识图、虚拟实训和故障诊断仅作为配套巩固工具。首本试点教材为《电气控制与PLC应用技术（S7-1200）》，该映射不是出版社或作者提供的官方配套资源，所有例题与练习均为平台原创，现有成绩与旧备份保持兼容。
