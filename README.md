...
电诊通是面向电气工程及其自动化专业学生的故障排查教学原型。公开测试版 v0.5 提供“三相异步电动机直接启动”和“三相异步电动机正反转控制”两个实验，支持随机隐藏故障、自动评分、错题复盘、薄弱项练习和按实验统计。
...
公开仓库建立后，请使用GitHub Issue模板提交软件故障、体验建议或专业内容纠错。不要上传真实设备、单位、人员或生产信息。参见 [CONTRIBUTING.md](CONTRIBUTING.md) 与 [SECURITY.md](SECURITY.md)。
