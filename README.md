...
电诊通是面向电气工程及其自动化专业学生的教材知识学习平台。v4.2 增加个人学习笔记与复习本，将笔记、知识点收藏和历史错题集中到统一入口，并支持匿名TXT/JSON导出。教材元数据、单元、小课、公式、原创例题和抽象图解从独立JSON内容包加载，并在启动时自动校验完整性与引用关系。识图、虚拟实训和故障诊断仅作为配套巩固工具。首本试点教材为《电气控制与PLC应用技术（S7-1200）》，该映射不是出版社或作者提供的官方配套资源，所有例题与练习均为平台原创，现有成绩与旧备份保持兼容。
...
- 引导学习模式、21张核心知识卡和不含真实接线信息的控制逻辑关系示意；
...
- 21张知识卡、90道题、20类模拟故障和18个识图案例均显示可追溯来源；
