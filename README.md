...
电诊通是面向电气工程及其自动化专业学生的电气知识与模拟实训学习平台。v1.8 新增“电气控制图识读基础”课程，通过安全的抽象逻辑图训练元件角色、串并联条件和控制路径追踪；不提供真实端子、电压或接线指导。匿名学习档案备份仍保持兼容。

> **仅用于教学模拟。** 不得用于真实设备诊断，不得替代持证电工、设备说明书或现场安全规程。本项目不提供带电测量、拆线、短接、送电或强制设备动作的指导。

## 功能范围

- 2门课程、6个章节的学习地图、完成状态与顺序解锁；
- 11个电气控制核心术语的集中解释；
- 3门课程、9个章节共55道教学题，每次随机抽取5题并即时解释；
...
- 引导学习模式、9张核心知识卡和不含真实接线信息的控制逻辑关系示意；
- 1分钟新手引导，说明实验选择、模拟资料阅读和三种判断；
- 原有14种故障保留参考原理与厂家资料；新增6种规则标记为待专业人员复核；
