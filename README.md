...
电诊通是面向电气工程及其自动化专业学生的教材知识学习平台。v3.6 已将项目1的单向旋转、正反转和星—三角启动三个单元全部建设为原创小课，提供即时检查、连续导航、单元进度、5题练习和项目学习总结；识图、虚拟实训和故障诊断仅作为配套巩固工具。首本试点教材为《电气控制与PLC应用技术（S7-1200）》，该映射不是出版社或作者提供的官方配套资源，现有成绩与旧备份保持兼容。
