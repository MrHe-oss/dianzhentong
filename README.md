...
电诊通是面向电气工程及其自动化专业学生的故障排查教学原型。v1.1 新手学习版提供“三相异步电动机直接启动”和“三相异步电动机正反转控制”两个实验，并增加1分钟新手引导和不计分示例题。应用同时支持每日学习任务、连续学习、实验掌握度、引导学习、自动评分、知识卡和推荐复习。14种模拟故障的报告还包含判断原因、易混淆项和记忆提示。
